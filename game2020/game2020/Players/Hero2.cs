...
{
    class Hero2 : IGameObject, ITransform
    {
        ...
        public Hero2(Texture2D texture, IInputReader inputReader)
        {
            this.heroTexture2 = texture;
        ...
        {
            spriteBatch.Draw(heroTexture2, Position, animation.CurrentFrame.SourceRectangle, Color.White, 0, new Vector2(-50, -50), 2f, SpriteEffects.None, 0);
        }
